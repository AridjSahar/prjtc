...
# load test data
tst_datagen = ImageDataGenerator(rescale=1.0/255.0, width_shift_range=0.1, height_shift_range=0.1, horizontal_flip=True,
                                     
                                     validation_split=0.2)

test_it= tst_datagen.flow_from_directory('train', class_mode='binary',shuffle=False, batch_size=32, target_size=(250, 250),subset='validation')
...
model = load_model('detection_waste_plastic.h5')
test_datagen = ImageDataGenerator(  rescale=1.0/255.0, width_shift_range=0.1, height_shift_range=0.1, horizontal_flip=True)
                                  
                                  
                              
    
test_it = test_datagen.flow_from_directory("test",class_mode='binary',
                                               shuffle=False, target_size=(250, 250))
